...
class urinalsTest {
    ...
    void maxFreeUrinals() {
        ...
        String inputString1 = "10001";
        assertEquals(Integer.parseInt("1"), urinals.maxFreeUrinals(inputString1));
        String inputString2 = "011";
        assertEquals(Integer.parseInt("-1"), urinals.maxFreeUrinals(inputString2));
    }
}